...
We create a class to add more fexibility and give a frame work for further developement. Here is a short description of the class "Trait_class" and couple functionality. The best way understand it is to play with the class using the Notebook.
